...
class RemocaoDeUrl:
    ...
    def tratar_texto(self, texto):
        ...
        """
        novo_texto = ''
        match_lst = re.findall(self.REMOVAL_OF_URLS_REGEX, texto)
        for match in match_lst:
            novo_texto = texto.replace(match, self.STRING_TO_REPLACE_URL)
        return novo_texto

def main():
    url_lst = ['http://www.youtube.com/watch?v=qsXHcwe3krw advadsv', 
